<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="viewbooks.aspx.vb" Inherits="viewbooks" title="Untitled Page" %>
...
<div align=center>
	<br/><br/>
			<table align=center><tr><td class="style2" 
                    style="font-family: 'Adobe Caslon Pro'; font-size: large; font-weight: bold; font-style: normal; color: #333333;">Search Books here:</td>
    ...
    <a href="viewbookdetails.aspx?bookid=<%#Eval("Bookname")%>">
    <asp:Image ID ="Image1" runat ="server" ImageUrl ='<%#"~\img\"+Eval("prod_image")%>' height="150" Width="150" />
   </a>  
    <br /><asp:Label ID="Label1" runat ="server" Text='<%#Eval("Bookname")%>' ForeColor="Black" Font-Size="Medium" Font-Bold="true"></asp:Label> 
<br /> Rs. <asp:Label ID="Label2" runat ="server" Text='<%#Eval("Price")%>' ForeColor="Blue" Font-Size="Medium" Font-Bold="true"></asp:Label> 
   </td> </tr>
