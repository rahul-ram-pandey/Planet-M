...
Partial Class viewvideodetails
    ...
    Public Function getdataset() As DataSet
        ...
        Dim con As New SqlConnection(strcon)
        con.Open()
        cmd = New SqlCommand("select * from adminvideo where moviename='" + p + "'", con)
        drs = cmd.ExecuteReader
        While drs.Read
            If drs("cdcopies") = 0 Then
    ...
    Public Sub bindgrid(ByVal ds As DataSet)
        Repeater1.DataSource = ds.Tables("adminvideo")
        Repeater1.DataBind()
    End Sub
