<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="viewvideos.aspx.vb" Inherits="viewvideos" title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<br/><br/>
			<table align=center><tr><td class="style2" 
                    style="font-family: 'Adobe Caslon Pro'; font-size: large; font-weight: bold; font-style: normal; color: #333333;">Search Video CD's here:</td>
 ...
 <div style=" width:926px ">
    ...
    <a href="viewvideodetails.aspx?movieid=<%#Eval("moviename")%>">
    <asp:Image ID ="Image1" runat ="server" ImageUrl ='<%#"~\images\videos\"+Eval("url")%>' height="150" Width="150" />
   </a>  
    <br /><asp:Label ID="Label1" runat ="server" Text='<%#Eval("moviename")%>' ForeColor="Black" Font-Size="Medium" Font-Bold="true"></asp:Label> 
